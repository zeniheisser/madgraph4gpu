...
c!$OMP END PARALLEL
      ...
      IF( FBRIDGE_MODE .EQ. 1 .OR. FBRIDGE_MODE .LT. 0 ) THEN ! (CppOnly=1 or BothQuiet=-1 or BothDebug=-2)
        ...
        IF ( FIRST ) THEN ! exclude first pass (helicity filtering) from timers (#461)
          write(*,*)  NEW_LINE('a'), NEW_LINE('a'), NEW_LINE('a'), NEW_LINE('a'),"we are in the fortran side of the bridge", NEW_LINE('a'), NEW_LINE('a'), NEW_LINE('a'), NEW_LINE('a')
