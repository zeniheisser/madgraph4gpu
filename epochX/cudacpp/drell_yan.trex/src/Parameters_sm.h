...
#endif
{
  ...
  public:
    ...
    cxsmpl<double> GC_1, GC_2, GC_3, GC_50, GC_58, GC_59;
...
#endif
{
  ...
  namespace Parameters_sm // keep the same name rather than HardcodedParameters_sm for simplicity
  {
    ...
    // Model couplings independent of aS
    constexpr cxsmpl<double> GC_1 = -( mdl_ee * mdl_complexi ) / 3.;
    constexpr cxsmpl<double> GC_2 = ( 2. * mdl_ee * mdl_complexi ) / 3.;
    constexpr cxsmpl<double> GC_3 = -( mdl_ee * mdl_complexi );
    constexpr cxsmpl<double> GC_50 = -( mdl_cw * mdl_ee * mdl_complexi ) / ( 2. * mdl_sw );
    constexpr cxsmpl<double> GC_58 = -( mdl_ee * mdl_complexi * mdl_sw ) / ( 6. * mdl_cw );
...
#pragma nv_diagnostic pop
  ...
  {
    constexpr size_t nicoup = 6; // #couplings that are fixed for all events because they do not depend on the running alphas QCD
    //constexpr size_t ixcoup_GC_1 = 0 + Parameters_sm_dependentCouplings::ndcoup; // out of ndcoup+nicoup
    //constexpr size_t ixcoup_GC_2 = 1 + Parameters_sm_dependentCouplings::ndcoup; // out of ndcoup+nicoup
    //constexpr size_t ixcoup_GC_3 = 2 + Parameters_sm_dependentCouplings::ndcoup; // out of ndcoup+nicoup
    //constexpr size_t ixcoup_GC_50 = 3 + Parameters_sm_dependentCouplings::ndcoup; // out of ndcoup+nicoup
    //constexpr size_t ixcoup_GC_58 = 4 + Parameters_sm_dependentCouplings::ndcoup; // out of ndcoup+nicoup
    //constexpr size_t ixcoup_GC_59 = 5 + Parameters_sm_dependentCouplings::ndcoup; // out of ndcoup+nicoup
  }
