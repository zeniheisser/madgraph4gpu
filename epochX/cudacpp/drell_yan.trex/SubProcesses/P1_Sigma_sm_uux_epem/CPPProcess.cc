...
#endif
{
  ...
  __device__ const fptype cIPC[nIPC * 2] = { (fptype)Parameters_sm::GC_2.real(), (fptype)Parameters_sm::GC_2.imag(), (fptype)Parameters_sm::GC_3.real(), (fptype)Parameters_sm::GC_3.imag(), (fptype)Parameters_sm::GC_50.real(), (fptype)Parameters_sm::GC_50.imag(), (fptype)Parameters_sm::GC_58.real(), (fptype)Parameters_sm::GC_58.imag(), (fptype)Parameters_sm::GC_59.real(), (fptype)Parameters_sm::GC_59.imag() };
#else
#ifdef MGONGPUCPP_GPUIMPL
...
#pragma nv_diagnostic pop
      ...
      FFV1P0_3<W_ACCESS, CI_ACCESS>( w_fp[0], w_fp[1], COUPs[ndcoup + 0], 1.0, 0., 0., w_fp[4] );
      ...
      FFV2_5_3<W_ACCESS, CI_ACCESS>( w_fp[0], w_fp[1], COUPs[ndcoup + 2], -1.0, COUPs[ndcoup + 3], 1.0, cIPD[0], cIPD[1], w_fp[4] );
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_1_uux_epem()?)
  ...
  CPPProcess::initProc( const std::string& param_card_name )
  {
    ...
    const cxtype tIPC[nIPC] = { cxmake( m_pars->GC_2 ), cxmake( m_pars->GC_3 ), cxmake( m_pars->GC_50 ), cxmake( m_pars->GC_58 ), cxmake( m_pars->GC_59 ) };
#ifdef MGONGPUCPP_GPUIMPL
