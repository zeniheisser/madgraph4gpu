...
//namespace dummy{
    ...
    std::vector<std::vector<int>> getInitPrts(){
        static std::vector<std::vector<int>> initPrts = {{2,-2},{2,-2},{4,-4},{4,-4}};
        return initPrts;
    }
    ...
    REX::eventSet getEventSet(){
        std::vector<std::vector<std::pair<int,int>>> eventVec = {{{-1,2},{-1,-2},{1,-11},{1,11}},{{-1,2},{-1,-2},{1,-13},{1,13}},{{-1,4},{-1,-4},{1,-11},{1,11}},{{-1,4},{-1,-4},{1,-13},{1,13}}};
