...
//namespace dummy{
    ...
    std::vector<std::vector<int>> getInitPrts(){
        static std::vector<std::vector<int>> initPrts = {{1,-1},{1,-1},{3,-3},{3,-3}};
        return initPrts;
    }

    std::vector<std::vector<int>> getFinPrts(){
        static std::vector<std::vector<int>> finPrts = {{-11,11},{-13,13},{-11,11},{-13,13}};
        return finPrts;
    }
    ...
    REX::eventSet getEventSet(){
        std::vector<std::vector<std::pair<int,int>>> eventVec = {{{-1,1},{-1,-1},{1,-11},{1,11}},{{-1,1},{-1,-1},{1,-13},{1,13}},{{-1,3},{-1,-3},{1,-11},{1,11}},{{-1,3},{-1,-3},{1,-13},{1,13}}};
