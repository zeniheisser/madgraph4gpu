...
#include <typeinfo>
#include <memory>
#include "P1_Sigma_sm_uux_epem/rwgt_runner.h"
#include "P1_Sigma_sm_ddx_epem/rwgt_runner.h"
...
int main( int argc, char** argv ){
    ...
    static std::vector<std::function<bool( REX::event& )>> comparators = {P1_Sigma_sm_uux_epem::getComp(),P1_Sigma_sm_ddx_epem::getComp()};
    ...
    static std::vector<rwgt::fBridge> fBridgeVec = {P1_Sigma_sm_uux_epem::bridgeConstr(),P1_Sigma_sm_ddx_epem::bridgeConstr()};
